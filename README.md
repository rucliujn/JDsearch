...
- history_time_list: the sequence of time interval after the last behavior in user histories. (the first one is 0) (including the final test query, thus the list's length is one more than other history lists)
